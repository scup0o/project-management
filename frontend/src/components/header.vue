        ...
        <div class="container-fluid">
            <div class="container">
                <div class="row" style="padding:5px" >
                    ...
                    <div class="col-3 d-flex justify-content-center bg-light"  style="margin: auto; color: white;">
                        
                    </div>

                    <!--icon-->
                    <div class="col-4 text-end d-flex justify-content-end" style="margin: auto;">
                        <!--chua dang nhap-->
                        ...
                        <div v-else>
                            <div id="header-icon" style="display: inline;">
                                ...
                                title="Tài khoản"
                                @click="this.$router.push({name:'account'}), title='Thông tin tài khoản'"
                                    ></i>
                            </div>
                            <button 
                                type="button" 
