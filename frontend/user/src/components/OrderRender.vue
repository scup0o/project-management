...
export default {
  ...
  methods: {
    ...
    async complete(){
        this.detailorder.status = 'Hoàn thành'
        this.detailorder = await OrderService.update(this.detailorder._id, this.detailorder)
    },

    async discard(){
        this.detailorder.status = 'Hủy'
        this.detailorder = await OrderService.update(this.detailorder._id, this.detailorder)
    }
  },
  computed:{
  ...
  <div class="row">
    <div class="col-7">
      ...
      >
        ...
        <div class="col-4 text-end" style="">Tổng giá trị</div>
        <div class="col-5 text-center" style="padding-left:60px">Trạng thái</div>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          <div
            class="col-3 text-center d-flex justify-content-center"
            style="margin: auto"
          >
            <div
              :class="{
      ...
      <div class="row" style="padding-top:10px">
        <div class="col text-center">
          ...
          <button
            ...
            @click="complete(), this.$toast.open({
